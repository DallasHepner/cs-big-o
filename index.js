...
// ANSWER: No its not possible. While for loops are usually O(n), the code inside the for loop prevents it from exceeding 4.
...
// ANSWER: I don't think there is an improvement that can be made.
...
// ANSWER: Each functions run time is determined by the string that is passed in.
